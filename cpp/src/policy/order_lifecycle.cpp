...
OrderStatus OrderLifecycle::afterCancelIncoming(const Quantity initialQty, const Quantity remainingQty) {
...
OrderStatus OrderLifecycle::afterCancelResting(const OrderStatus currentStatus) {
